...
if __name__ == '__main__':
    ...
    with gr.Blocks() as app:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column():
                textbox = gr.TextArea(label="Conversation content",
            ...
            with gr.Column():
                text_output = gr.Textbox(label="reply message")
                audio_output = gr.Audio(label="audio information", elem_id="tts-audio")
                generate = gr.Button("Generate dialogue")
                upload = gr.UploadButton('Read chat history', file_types=['file'])
                logdown = gr.Button("Record current chat history")
